...
def tsne(X=np.array([]), no_dims=2, initial_dims=50, method='tsne'):
    """
    ...
    for iter in range(max_iter):
        ...
        if (iter%50 == 0):
        	visualization(Y ,method, iter, labels)
...
if __name__ == "__main__":
    ...
    Y, P, Q = tsne(X, 2, 50, method='ssne')
    visualization_pair(P, Q, 'ssne')


    print('tsne part')

    Y, P, Q = tsne(X, 2, 50, method='tsne')
    visualization_pair(P, Q, 'tsne')